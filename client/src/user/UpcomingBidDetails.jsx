      ...
      <section className="w-[1200px] mx-auto mt-[75px] mb-20">
        ...
        <div className=" font-cantora text-base font-semibold tracking-wide text-red-600 mt-8 text-center">
          <span className="text-xl">*Note : </span> 
              You can keep track of the event date and on the event day, you will get a reminder call and email. So kindly check the mails 
              for any update. 
        </div>
      </section>
      <Footer />
...
export default UpcomingBidDetails;