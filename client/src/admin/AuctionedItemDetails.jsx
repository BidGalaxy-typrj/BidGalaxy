...
function AuctionedItemDetails() {
  ...
  useEffect(() => {
    ...
    //Fetch Buyer details using product Id
  ...
  const fetchBuyerDetails = (id) => {
    axios.get(`http://localhost:8081/admin/AuctionedItemDetails/${id}`)
    .then((res) => {
      // console.log('Fetched Buyer Details:', res.data);
    ...
    <div>
      ...
      <section className="w-[1200px] mx-auto mt-[75px] mb-20">
        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="flex flex-col items-start">
            <div className="mb-4">
              <div className="textColor text-xl font-cantora uppercase font-bold">sold in</div>
              <div className="text-gray-700 font-cantora text-base uppercase mt-2">{buyerDetails.final_price || 'NA'}</div>
            </div>
            <div className="mb-4">
              <div className="textColor text-xl font-cantora uppercase font-bold">buyer</div>
              <div className="text-gray-700 font-cantora text-base uppercase mt-2">{buyerDetails.buyer_name || 'NA'}</div>
            </div>
            <div className="mb-4">
              <div className="textColor text-xl font-cantora uppercase font-bold">buyer details</div>
              <div className="text-gray-700 font-cantora text-base mt-2">{buyerDetails.buyer_email || 'NA'}</div>
              <div className="text-gray-700 font-cantora text-base uppercase mt-2">{buyerDetails.buyer_contact || 'NA'}</div>
            </div>
          </div>
        </div>
        <div className="mb-4">
...
export default AuctionedItemDetails;
